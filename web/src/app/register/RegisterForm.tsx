        ...
        <div className="mx-auto max-w-[1180px] px-11 pt-10 pb-24">
          ...
          <div className="glass mt-7 max-w-[560px] p-7">
            <div className="flex items-center gap-2.5 rounded-[10px] border border-ok/30 bg-ok/10 p-3.5 text-[12.5px] text-ok">
              <Icon name="check" />
              已報名「{nickname}」，Suno 帳號 {sunoHandle} 已登記，可以前往「投稿」頁提交作品了
            </div>
            <button
    ...
    <div>
      ...
      <div className="mx-auto max-w-[1180px] px-11 pt-10 pb-24">
        ...
        <div className="glass max-w-[560px] p-7">
          ...
          <p className="mb-4 mt-4 text-[11.5px] text-ink-faint">
            報名開放時間不會晚於本場比賽的投稿期結束 — 投稿期一旦截止，此表單會自動關閉，不會再收到新報名。
          </p>

          <button
            className="w-full rounded-[10px] bg-gradient-to-r from-[#ff9457] via-accent to-accent-2 py-3 text-[13.5px] font-semibold text-[#1a0e08] disabled:opacity-45"
            disabled={!canSubmit}
